...
> **_"You can work as a mechanic on my team. But when it comes to your mission as a spy, I don't want anything to do with it."_                  ―Jarek Yeager, to Kazuda Xiono**
...
[2]: https://smittenkitchendotcom.files.wordpress.com/2019/02/chocolate-puddle-cakes.jpg?w=750 "Logo Title Text 2"
### **Ingredients**
...
In [Cartesian coordinates](https://en.wikipedia.org/wiki/Cartesian_coordinate_system), if **p** = (*p1, p2,..., pn*) and **q** = (*q1, q2,..., qn*) are two points in Euclidean n-space, then the distance (d) from **p** to **q**, or from **q** to **p** is given by the **Pythagorean formula**:\\
*d*($\mathbf{p}$,$\mathbf{q}$,=*d*($\mathbf{q}$,$\mathbf{p}$)=$\sqrt{(q_1-p_1)^2+(q_2-p_2)^2+\dots+(q_n-p_n)^2}$\
\
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;＝$\sqrt{\displaystyle\sum_{i=1}^{n}(q_i-p_i)^2}$\
\
